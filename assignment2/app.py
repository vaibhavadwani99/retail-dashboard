...
api.add_resource(Total_sales, "/total_sales/<string:name>")
api.add_resource(Average_sales, "/average_sales/<string:name>")
api.add_resource(Unique_visitors, "/unique_visitors/<string:name>")
