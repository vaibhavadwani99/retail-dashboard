...
api.add_resource(Total_sales, "/total_sales/<string:date>")
api.add_resource(Average_sales, "/average_sales/<string:date>")
api.add_resource(Unique_visitors, "/unique_visitors/<string:date>")
